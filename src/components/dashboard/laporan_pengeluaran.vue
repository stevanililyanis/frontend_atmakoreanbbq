...
export default {
    ...
    methods:{
        getLaporanTahunan(tahunMulai, tahunSelesai){
            this.lapTahunan=[]
            var url = this.$api + '/laporan-pengeluaran-tahunan/'+tahunMulai+'/'+tahunSelesai
            this.$http.get(url, {
            headers: {
            ...
            var lap=[];
                ...
                lap.total_pengeluaran= Number(lap.makanan) + Number(lap.side_dish) + Number(lap.minuman);
        ...
        getLaporanBulanan(tahun){
            this.lapBulanan=[]
            var url = this.$api + '/laporan-pengeluaran-bulanan/'+tahun
            this.$http.get(url, {
            headers: {
            'Authorization': 'Bearer ' + localStorage.getItem('access_token')
            }
            ...
            this.lapBulanan.forEach(bulan => {
                ...
                bulan.total_pengeluaran = Number(bulan.makanan) + Number(bulan.minuman) + Number(bulan.side_dish)
